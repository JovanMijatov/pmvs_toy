...
namespace PMVS3 {
    ...
    class Coptim {
        public:
            ...
            void computeUnits(const Patch::Cpatch& patch, std::vector<int>& indexes, std::vector<float>& fineness,
            ...
            void refinePatch_additional(Patch::Cpatch& patch, const int id, const int time, int level);

            bool refinePatchBFGS(Patch::Cpatch& patch, const int id, const int time, const int ncc);
            bool refinePatchBFGS_finetune_level1(Patch::Cpatch& patch, const int id, const int time, const int ncc);
            bool refinePatchBFGS_finetune_level2(Patch::Cpatch& patch, const int id, const int time, const int ncc);
        ...
        protected:
            ...
            int grabSafe(const int index, const int size, const Vec3f& center, const Vec3f& dx, const Vec3f& dy,
            ...
            double computeINCC(const Vec4f& coord, const Vec4f& normal,
                               ...
                               const int robust);
            */
            double computeINCC(const Vec4f& coord,
                               const Vec4f& normal,
                               const std::vector<int>& indexes,
                               const Vec4f& pxaxis,
                               const Vec4f& pyaxis,
        ...
        protected:
            ...
            static double my_f3(unsigned n, const double* x, double* grad, void* my_func_data);
