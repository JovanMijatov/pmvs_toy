...
namespace PMVS3 {
    ...
    class CpatchOrganizerS {
        public:
            ...
            void collectPatches(const int index, std::priority_queue<Patch::Ppatch, std::vector<Patch::Ppatch>,
                                                                     P_compare>& pqpatches);
            ...
            void writePLY_cpatch(const std::vector<Patch::Cpatch>& patches, const std::string filename);
            ...
            std::vector<Patch::Cpatch> m_optimized_patches;
