...
namespace PMVS3 {
    class CfindMatch {
        public:
            ...
            int isNeighborRadius(const Patch::Cpatch& lhs,
                                 const Patch::Cpatch& rhs,
                                 const float hunit,
                                 const float neighborThreshold,
                                 const float radius) const;

            int finalOptimization();

            int isNeighbor(const Patch::Cpatch& lhs, const Patch::Cpatch& rhs, const float hunit,
            ...
            // windows size
            int m_wsize;
            int m_wsize_refine_scale_1;
            int m_wsize_refine_scale_2;
